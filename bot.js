...
client.user.setGame(` Amr `,"https://www.twitch.tv/dggamingbot")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
const config = { prefix: "*", token: "NTQzMTk5NzYzOTk5MjI3OTI3.Dz5GgA.dkMee3DqELB5Lsloll-IVOBLbz0" };
const tpoints = {};
const vpoints = {};
hero.config = config;
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('**Bot Owner**👑 :' , `[<@512593210334511104>]` , true)
            .setFooter(message.author.username, message.author.avatarURL)
    })
}
});
